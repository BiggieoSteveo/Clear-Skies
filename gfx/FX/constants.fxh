...
static const float GB_CAM_MIN = 345.0f;
...
static const float GB_THRESHOLD = 0.9f; // interpolation time
static const float GB_THRESHOLD2 = 0.9f; // interpolation time
...
static const float BORDER_FOW_REMOVAL_FACTOR = 0.2f; // How much of the FOW that is removed from the borders. 1.0f is no FOW
